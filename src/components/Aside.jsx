 ...
 <>    {/* Sidebar starts */}
  <div className="absolute lg:relative w-64 h-screen shadow bg-gray-100 hidden lg:block">
        <div className="h-16 w-full flex items-center px-8">
          ...
          <svg version="1.0" xmlns="http://www.w3.org/2000/svg  "  width="239.000000pt" height="77.000000pt" viewBox="0 0 239.000000 77.000000"  preserveAspectRatio="xMidYMid meet">  <g   fill="#5F7DF2" transform="translate(0.000000,77.000000) scale(0.100000,-0.100000)"   stroke="none"> <path   fill="#5F7DF2" d="M588 509 c-23 -13 -23 -25 1 -55 l19 -25 16 23 c20 29 20 54 0 62 -19 7 -15 8 -36 -5z"/> <path  fill="#5F7DF2" d="M1806 432 c-42 -5 -77 -31 -93 -70 -13 -30 -12 -38 6 -75 11 -23 41 -64 66 -92 l45 -50 49 55 c68 75 88 119 71 160 -20 49 -81 80 -144 72z m39 -83 c-4 -5 -2 -9 4 -9 5 0 11 6 13 12 3 8 9 4 17 -10 24 -44 -31 -88 -78 -62 -25 13 -28 61 -5 81 9 7 13 21 10 33 -4 18 -1 16 20 -7 13 -16 22 -33 19 -38z m47 38 c9 -7 19 -26 23 -43 4 -23 4 -25 -4 -8 -5 12 -22 31 -38 42 -17 13 -22 21 -13 21 8 0 23 -5 32 -12z m-48 -150 c15 -11 16 -15 3 -25 -19 -16 -47 -5 -47 19 0 22 19 25 44 6z"/> <path d="M360 275 c0 -113 2 -135 15 -135 12 0 15 13 15 60 l0 59 57 3 c81 4 85 28 4 28 l-61 0 0 48 0 48 65 -4 c55 -4 65 -2 65 12 0 13 -13 16 -80 16 l-80 0 0 -135z"/> <path d="M590 275 c0 -113 2 -135 15 -135 13 0 15 22 15 135 0 113 -2 135 -15 135 -13 0 -15 -22 -15 -135z"/> <path d="M710 275 c0 -131 1 -135 21 -135 20 0 21 4 16 60 l-5 60 59 0 c46 0 59 3 59 15 0 12 -13 15 -59 15 l-58 0 1 48 1 47 68 -3 c56 -3 67 -1 67 12 0 13 -14 16 -85 16 l-85 0 0 -135z"/> <path d="M923 398 c2 -8 22 -13 47 -13 l43 0 -2 -122 c-2 -120 -2 -123 19 -123 21 0 22 3 19 123 l-3 122 43 0 c26 0 46 5 48 13 4 9 -22 12 -107 12 -85 0 -111 -3 -107 -12z"/> <path d="M1221 323 c46 -80 50 -92 45 -135 -4 -43 -3 -48 14 -48 18 0 20 7 20 58 0 32 4 62 8 68 5 5 26 39 46 77 32 58 35 67 19 67 -13 0 -29 -21 -51 -65 -19 -36 -37 -65 -41 -65 -4 0 -21 29 -39 65 -23 46 -37 65 -51 65 -17 0 -12 -12 30 -87z"/> <path d="M1465 349 c-8 -69 1 -88 33 -68 32 20 76 1 80 -35 5 -43 -6 -74 -28 -81 -28 -9 -58 3 -65 26 -7 21 -35 26 -35 6 0 -25 45 -57 79 -57 45 0 67 14 80 50 23 69 -13 125 -80 124 -39 -1 -40 -1 -37 30 3 30 4 31 61 34 42 2 57 7 57 17 0 12 -15 15 -69 15 l-69 0 -7 -61z"/> </g> </svg> 
        </div>
        <ul aria-orientation="vertical" className=" py-6">
            ...
            <div className="flex items-center">
              <div>
                <svg
                  ...
                  className="icon icon-tabler icon-tabler-grid text-black"
                  width={20}
                  height={20}
                  viewBox="0 0 24 24"
                  strokeWidth="1.5"
              ...
              <Link to="/home"> <span className="ml-2 text-black">Dashboard</span></Link>
            </div>
          </li>
          <li className="pl-6 cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mt-4 mb-4 py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
            <div className="flex items-center">
             ...
             <Link to="/customers"> <span className="ml-2">Users</span></Link>
            </div>
          </li>
          <li className="pl-6 cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mb-4 py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
            <div className="flex items-center">
              ...
              <Link to="/orders"> <span className="ml-2">Orders</span></Link>
          ...
          <li className="pl-6 cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
            <div className="flex items-center">
              ...
              <Link to="/offers"> <span className="ml-2">Offers</span></Link>
            </div>
          </li>
        </ul>
      </div>
