    ...
    useEffect(() => {
        let options = {
          ...
          series: [
            {
              name: "New orders",
              data: orders || [6500, 6418, 6456, 6526, 6356, 6456],
              color: "#1A56DB",
            },
          ]
        };
        ...
        let chart;
        if (document.getElementById("orders-area-chart") && typeof ApexCharts !== 'undefined') {
          chart = new ApexCharts(document.getElementById("orders-area-chart"), options);
          chart.render();
        }
      ...
      }, [orders]); // dependency to rerun useEffect when users prop changes
    
    return (
        <div class="max-w-sm w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
        <div class="flex justify-between">
          <div>
            <h5 class="leading-none text-3xl font-bold text-gray-900 dark:text-white pb-2">{orders.length}</h5>
